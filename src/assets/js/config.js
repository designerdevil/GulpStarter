...
(function ($){
    ...
    (function(){
        var ua = navigator.userAgent;
            eu.cfg.isMobileApp = /ETMOBILEAPP|ETMOBILELB|ETMOBILEENTRY/.test(ua);
            eu.cfg.isIphone = /iPhone/i.test(ua);
            eu.cfg.isIpad = /iPad/i.test(ua);
        ...
        eu.cfg.breakPoints ={
            XS    :'screen and (min-width:0px) and (max-width:768px)',
           // SMX   :'screen and (min-width:481px) and (max-width:767px)',
            SM    :'screen and (min-width:769px) and (max-width:1024px)',
        ...
        eu.events = {
            WINDOW_RESIZE : 'eu/screen/resize/',
            WINDOW_LOAD : 'eu/window/load/',
            SCROLL : 'eu/mouse/scroll',
            VIEWPORT_CHANGE : 'eu/viewport/change', //for responsive implementation
            INIT_MODULES : 'eu/modules/init',
           ...
           // VIEWPORT_MD_LG:'viewport/desktopAndAbove'
            TAB_CHANGE_BEFORE: 'eu/tab-event/before',
            TAB_CHANGE_AFTER: 'eu/tab-event/after',
            FOLLOWING_TAB_CHANGE: 'eu/mini-ldrbrd/tab',//This event will trigger from mini leaderboard following tab state change. Need to handle by JQ tab comp.
            TOGGLE_FOLLOWING_FROM_STORE : 'eu/mini-leaderboard-following',
            TOGGLE_FOLLOWING_FROM_SERVICE : 'eu/mini-leaderboard-following-service',

            SHOW_ALERT: "eu/show-alert",
            SHOW_NOTIFICATION : "eu/show-notification",
            LOAD_NOTIFICATION : "eu/load-notification",
            ADD_FOLLOWING_PLAYER : "eu/add-following-player",
            REMOVE_FOLLOWING_PLAYER : "eu/remove-following-player", //TODO: Will remove once we have following Player servive
            UPDATE_FOLLOWING_PLAYERS : "eu/update-following-player", //TODO: Will remove once we have following Player servive,
            INIT_REACT_APP_SERVICE: 'eu/init-app-services',
            START_LB_DATA_SERVICE: 'eu/init-lb-data-services',
            START_R2D_DATA_SERVICE: 'eu/init-r2d-data-services',
            ON_R2D_PREDICTION_DATA: 'eu/on-r2d-prediction-data-recieve',
            LOAD_PAGE_JSON : 'eu/load-page-json',
            PROJECTED_CUT_APPLIED : 'eu/project-cut-applied',
            PLAY_OFF_APPLIED : 'eu/play-off-applied',
            UPDATE_PLAY_OFF : 'eu/update-play-off',
            CLEAR_SEARCH_TERM: "eu/clear-search-term",
            SEARCH_OPEN: "eu/search-open",
            SEARCH_CLOSE: "eu/search-close",
            MEDIA_TAB_CLICKED: "eu/media-tab-clicked",
            STATS_TAB_CLICKED: "eu/stats-tab-clicked",
            INIT_PRO_AM_SERVICES: 'eu/init-pro-am-services',
            TAB_ACTIVATED:'eu/cp014-tab-activate',
            UPDATE_FOLLOWING_FROM_REACT:'eu/update_following_from_react'
        };
